...
import os,sys
try: import requests
except ModuleNotFoundError:print("YASIN Install Module requests");os.system("python -m pip install requests &> /dev/YASIN")
try: import bs4
except ModuleNotFoundError:print("YASIN Install Module bs4");os.system("python -m pip install bs4 &> /dev/YASIN")
try: import mechanize
except ModuleNotFoundError:print("YASIN Install Module mechanize");os.system("python -m pip install mechanize &> /dev/YASIN")
try: import gTTS
...
def main_apv():
    ...
    if key1 in r1:
        ...
        print ("[*]--------------------------------------------------------------")
        time.sleep(3.5)
        os.system("xdg-open https://wa.me/+93305867095")
